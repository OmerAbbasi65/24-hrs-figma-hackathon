            ...
            <div class="container px-5 pt-24 pb-0 mx-auto" bis_skin_checked="1">
                <div class="flex flex-wrap md:text-left text-center order-first" bis_skin_checked="1">
                    ...
                    <div class="lg:w-1/5 md:w-1/2 w-full px-4" bis_skin_checked="1">
                        ...
                        <nav class="list-none mb-10">
                            <li>
                                <a class="leading-[75px]  font-semibold hover:text-gray-800 cursor-pointer text-black">Payment Options</a>
                            </li>
                            <li>
                                <a class="leading-[75px]  font-semibold hover:text-gray-800 cursor-pointer text-black">Returns</a>
                            </li>
                            <li>
                                <a class="leading-[75px]  font-semibold hover:text-gray-800 cursor-pointer text-black">Privacy Policies</a>
                            </li>
